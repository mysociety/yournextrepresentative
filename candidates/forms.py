...
class SettingsForm(forms.ModelForm):
    class Meta:
        model = SiteSettings
        fields = (
            'SITE_OWNER', 'SITE_OWNER_URL', 'COPYRIGHT_HOLDER',
            'TWITTER_USERNAME',
            'SUPPORT_EMAIL', 'DEFAULT_FROM_EMAIL', 'SERVER_EMAIL',
            'DATE_FORMAT', 'DD_MM_DATE_FORMAT_PREFERRED',
            'MAPIT_BASE_URL',
            'GOOGLE_ANALYTICS_ACCOUNT', 'USE_UNIVERSAL_ANALYTICS',
