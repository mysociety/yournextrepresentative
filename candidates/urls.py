...
urlpatterns = patterns('',
    ...
    url(r'^constituencies/declared$', views.ConstituenciesDeclaredListView.as_view(), name='constituencies-declared'),
    url(r'^constituency/(?P<mapit_area_id>\d+)/record-winner$',
        views.ConstituencyRecordWinnerView.as_view(),
        name='record-winner'),
    url(r'^constituency/(?P<mapit_area_id>\d+)/retract-winner$',
    ...
    url(r'^all-edits-disallowed$',
        TemplateView.as_view(template_name="candidates/all-edits-disallowed.html"),
