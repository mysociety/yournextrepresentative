...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LoggedAction.ip_address'
        db.add_column(u'candidates_loggedaction', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LoggedAction.ip_address'
        db.delete_column(u'candidates_loggedaction', 'ip_address')
