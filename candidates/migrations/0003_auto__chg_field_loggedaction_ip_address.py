...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LoggedAction.ip_address'
        db.alter_column(u'candidates_loggedaction', 'ip_address', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'LoggedAction.ip_address'
        db.alter_column(u'candidates_loggedaction', 'ip_address', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
