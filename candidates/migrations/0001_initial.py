...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MaxPopItIds'
        db.create_table(u'candidates_maxpopitids', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('popit_collection_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('max_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'candidates', ['MaxPopItIds'])

        # Adding model 'LoggedAction'
        db.create_table(u'candidates_loggedaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('popit_person_new_version', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('popit_person_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('source', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'candidates', ['LoggedAction'])


    def backwards(self, orm):
        # Deleting model 'MaxPopItIds'
        db.delete_table(u'candidates_maxpopitids')

        # Deleting model 'LoggedAction'
        db.delete_table(u'candidates_loggedaction')
