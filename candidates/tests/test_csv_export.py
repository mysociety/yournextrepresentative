...
class CSVTests(TestCase):
    ...
    def test_as_dict(self):
        ...
        self.assertEqual(len(person_dict), 22)
    ...
    def test_csv_output(self):
        example_output = '' + \
        'name,id,party,constituency,mapit_id,mapit_url,gss_code,twitter_username,facebook_page_url,party_ppc_page_url,gender,facebook_personal_url,email,homepage_url,wikipedia_url,birth_date,parlparse_id,theyworkforyou_url,honorific_prefix,honorific_suffix,party_id,linkedin_url\r\n' \
